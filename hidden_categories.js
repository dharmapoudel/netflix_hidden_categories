$(function(){
    var hidden_categories = {
        ...
        '26' : 'Mockumentaries',
        '947' : 'Monster Movies',
        '10056' : 'Movies based on childrens books',
    ...
    function add_hidden_categories(){
        var hiddenCategoriesDiv = $('<div />', {  class:'sub-menu theme-larika genreNav hasSpecialItems'});
        var listUL = $('<ul />', {class:'hidden_categories_list'});
        $.each(hidden_categories, function(key, value){
            var listItem = $('<li />', { 
                class: 'hidden_category_'+key,
                html:'<a href="http://www.netflix.com/browse/genre/'+key+'">'+value+'</a>'
            });
            listUL.append(listItem);
        });
        $(hiddenCategoriesDiv).append(listUL);
        return hiddenCategoriesDiv;
    }
    ...
    $(document).ready(function() {
        var li = $("<li />", {
            text:'Categories',
            class:'hidden_categories active hasSubMenu browse',
            html:'<span class="categories">Categories</span><span class="caret"></span>'
            
        });
        
        var hiddenCategories = add_hidden_categories();
        li.append(hiddenCategories);
        $('li.browse').after(li);
